...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React50.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React50.useRef(false);
  const handleEntering = React50.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React50.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React50.useCallback(() => {
    dispatch("exiting");
  }, []);
...
var Select = React55.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime32.jsxs)(React55.Fragment, {
...
var Slider = React56.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime34.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime33.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime33.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime34.jsxs)(React56.Fragment, {
...
function CssTransition(props) {
  ...
  const [isEntering, setIsEntering] = React74.useState(!requestedEnter);
  React74.useEffect(() => {
    if (requestedEnter) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YEFINWIC.js.map
